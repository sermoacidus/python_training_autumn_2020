...
def run():
    ...
    # oop_hw = Homework(text="Learn OOP", deadline=datetime.timedelta(days=1), created_by=oop_teacher)
    # oop_hw.save()
    # result_1 = HomeworkResult(given_task=oop_hw, author=lazy_student, solution='I have done this hw ')
    # result_1.save()
